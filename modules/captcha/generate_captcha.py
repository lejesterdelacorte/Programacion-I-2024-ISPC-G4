...
def generate_captcha():
    ...
    try:
        ...
        return compare_result(user_result, result)
...
def compare_result(user_result, result):
    if user_result == result:
        ...
        return True
    user_choice = input('El resultado es incorrecto.\n Si deseas cancelar el registro ingresa "n" de lo contrario te daremos otro captcha: ').lower()
    if user_choice == 'n':
