...
ALTER TABLE `sharing_books`.`domicilio` AUTO_INCREMENT = 1;
...
ALTER TABLE `sharing_books`.`usuario` AUTO_INCREMENT = 1;
...
ALTER TABLE `sharing_books`.`acceso` AUTO_INCREMENT = 1;
...
ALTER TABLE `sharing_books`.`libro` AUTO_INCREMENT = 1;
...
ALTER TABLE `sharing_books`.`punto_encuentro` AUTO_INCREMENT = 1;
...
ALTER TABLE `sharing_books`.`intercambio` AUTO_INCREMENT = 1;
